...
# - Forces higher camera res on macOS (AVFoundation) + MJPG
# - Super-res plate crops and multi-prep second-pass OCR (PaddleOCR 'japan')
...
def prep_kana_variants(bgr):
    ...
    gamma = 1.0
    if mean > 1.0:
        # compute a gentle gamma based on mean
        target = 160.0
